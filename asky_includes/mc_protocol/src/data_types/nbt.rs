...
use asky_binutils::prelude::{BinaryWriter, BinaryWriterError};
use asky_nbt::{NbtOptions, Value};
...
impl EncodePacket for Value {
    fn encode(
        ...
        let nbt_bytes =
            asky_nbt::to_bytes_with_options(self, None, from_protocol_version(protocol_version))
